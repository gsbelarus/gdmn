...
* [ ] :running: Инкрементная подгрузка данных для больших наборов данных.
...
* [ ] :running: Режим кластера.
* [ ] :running: Вынос долговыполняющихся задач в child_process.
* [ ] :running: Инкрементная подгрузка данных для больших наборов данных.
...
* [ ] :running: Реализация режима неполной загрузки и инкрементной подгрузки данных.
