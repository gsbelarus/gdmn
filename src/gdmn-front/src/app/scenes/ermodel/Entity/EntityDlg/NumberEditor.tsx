    ...
    />
    {
      ...
      ? <>
          <Dropdown
            ...
            options={ new Array(18).fill(undefined).map( (i, idx) => ({ key: idx + 1, text: (idx + 1).toString() }) ) }
          ...
          <Dropdown
            ...
            options={ new Array(18).fill(undefined).map( (i, idx) => ({ key: idx, text: idx.toString() }) ).filter( i => i.key <= attr.scale ) }
