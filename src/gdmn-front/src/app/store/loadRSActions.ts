...
export const loadRSActions = {
  ...
  attachRS: createAction('LOADRS/ATTACH_RS', resolve => (params: { name: string, eq: EntityQuery, queryPhrase?: string, override?: boolean, masterLink?: IMasterLink, sufix?: string }) => resolve(params) ),
