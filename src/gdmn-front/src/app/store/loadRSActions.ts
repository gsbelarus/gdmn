...
export const loadRSActions = {
  ...
  attachRS: createAction('LOADRS/ATTACH_RS', resolve => (params: { name: string, eq: EntityQuery, queryPhrase?: string, override?: boolean, entityMaster: boolean }) => resolve(params) ),
