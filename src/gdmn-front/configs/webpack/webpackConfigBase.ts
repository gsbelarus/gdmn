      ...
      rules: [
        {
          ...
          use: 'exports-loader?' + [
            ...
            'mxPrintPreview', 'mxToolbar', 'mxOutline', 'mxCellTracker', 'mxCellOverlay', 'mxImage', 'mxPopupMenu', 'mxCylinder', 'mxRectangle', 'mxCellRenderer', 'mxVertexHandler', 'mxPoint',
            'mxHandle', 'mxRhombus', ' mxActor', 'mxArrow', 'mxArrowConnector', 'mxCloud', 'mxConnector', 'mxEllipse', 'mxHexagon', 'mxImageShape', 'mxLabel', 'mxLine', 'mxPolyline', 'mxRectangleShape',
            'mxShape', 'mxStencil', 'mxSwimlane', 'mxText', 'mxTriangle', 'mxAutoSaveManager', 'mxDivResizer', 'mxForm', 'mxGuide', 'mxImageBundle', 'mxImageExport', 'mxMorphing', 'mxMouseEvent',
            'mxPanningManager', 'mxSvgCanvas2D', 'mxUndoableEdit', 'mxUndoManager', 'mxWindow', 'mxXmlCanvas2D', 'mxXmlRequest', 'mxCellEditor', 'mxCellState', 'mxCellStatePreview', 'mxConnectionConstraint',
            ...
            'mxSwimlaneLayout', 'mxObjectCodec', 'mxTooltipHandler', 'mxSelectionCellsHandler', 'mxPopupMenuHandler', 'mxGraphHandler', 'mxElbowEdgeHandler', 'mxEdgeHandler',
