...
export const morphTokens = (() => {
  ...
  const signatures = [
    ...
    'VERBIntrImpfPresSing1perIndc',
    'VERBTranImpfPresSing1perIndc',
    'VERBIntrImpfPresPlur1perIndc',
    'VERBTranImpfPresPlur1perIndc',
    'VERBIntrImpfPresSing2perIndc',
    'VERBTranImpfPresSing2perIndc',
    'VERBIntrImpfPresPlur2perIndc',
    'VERBTranImpfPresPlur2perIndc',
